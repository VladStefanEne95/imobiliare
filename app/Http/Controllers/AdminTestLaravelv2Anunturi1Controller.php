<?php namespace App\Http\Controllers;
	...
	class AdminTestLaravelv2Anunturi1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Structura De Rezistenta','name'=>'structura_de_rezistenta','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Nr Camere','name'=>'nr_camere','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Suprafata Utila','name'=>'suprafata_utila','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Suprafata Utila Totala','name'=>'suprafata_utila_totala','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Suprafata Construita','name'=>'suprafata_construita','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Regim Inaltime','name'=>'regim_inaltime','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Confort','name'=>'confort','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Etaje','name'=>'etaje','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Tip Imobil','name'=>'tip_imobil','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Locuri Parcare','name'=>'locuri_parcare','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Nr Garaje','name'=>'nr_garaje','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Nr Bai','name'=>'nr_bai','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Nr Balcoane','name'=>'nr_balcoane','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Nr Bucatarii','name'=>'nr_bucatarii','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Compartimentare','name'=>'compartimentare','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'An Constructie','name'=>'an_constructie','type'=>'text','width'=>'col-sm-10'];
